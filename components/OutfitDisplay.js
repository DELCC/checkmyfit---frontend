          ...
          >
              ...
              {/* <View style={styles.stylistCard}>
                <View style={styles.avatar}>
                  <Text style={styles.avatarText}>
                    {selectedStylist.initials}
                  </Text>
                </View>
                <View>
                  <Text style={styles.stylistName}>{selectedStylist.name}</Text>
            ...
            <View style={styles.actions}>
              ...
              {/* <TouchableOpacity
                ...
                onPress={shareOutfit}
              >
                <Text style={styles.outlineButtonText}>Share This Look</Text>
              </TouchableOpacity> */}
              <TouchableOpacity
                style={[styles.button, styles.outlineButton]}
                onPress={onClose}
              >
                <Text style={styles.outlineButtonText}>Go Back Home</Text>
              </TouchableOpacity>
            </View>
          </ScrollView>
        </SafeAreaView>
