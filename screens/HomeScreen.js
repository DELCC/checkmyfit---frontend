...
import { Bell, Settings, Sparkles, Camera, Heart, Upload, Search} from "lucide-react-native";
...
export default function HomeScreen() {
  ...
  const clothingItems = [
    {
      id: 1,
      image: 'https://images.unsplash.com/photo-1589270216117-7972b3082c7d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxtaW5pbWFsJTIwZmFzaGlvbiUyMGNsb3RoaW5nfGVufDF8fHx8MTc2MDg3NjM5OHww&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral',
    ...
    {
      id: 2,
      image: 'https://images.unsplash.com/photo-1596484552993-aec4311d3381?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxjYXN1YWwlMjB3YXJkcm9iZXxlbnwxfHx8fDE3NjA5NDYxMTZ8MA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral',
      name: 'Relaxed Denim',
      category: 'Bottoms',
      color: 'Blue',
      brand: 'Urban',
   ...
   const outfitSuggestions = [
    {
      id: 1,
      image: 'https://images.unsplash.com/photo-1757782630148-78c633bb732c?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxzdHlsaXNoJTIwb3V0Zml0fGVufDF8fHx8MTc2MDg0Njc3MHww&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral',
        ...
        <ScrollView contentContainerStyle={{ padding: 16 }}>
              ...
              <View style={styles.grid}>
                {colors.map((color, i) => (
                  <View key={i} style={styles.colorItem}>
                    {color.gradient ? (
                      <LinearGradient colors={color.gradient} style={styles.colorBox} />
                    ) : (
                      <View
                        style={[
                          styles.colorBox,
          ...
          <View style={styles.section}>
            ...
            <View style={styles.typographyContainer}>
                ...
                <Text style={styles.body}>Body text – The quick brown fox jumps over the lazy dog</Text>
                <Text style={styles.caption}>Caption text – Additional information</Text>
            </View>
          </View>
          <View style={styles.section}>
                ...
                <View style={styles.buttonsContainer}>
                    ...
                    <Text style={[styles.buttonText, styles.textLight]}>Primary Button</Text>
                    </TouchableOpacity>
                    {/* </LinearGradient> */}
                    ...
                    <Text style={[styles.buttonText, styles.textDark]}>Secondary Button</Text>
                    </TouchableOpacity>

                    {/* Outline Button */}
                    <TouchableOpacity style={[styles.button, styles.outlineButton]}>
                    <Heart size={18} color="#00A6A6" style={styles.iconLeft} />
                    <Text style={[styles.buttonText, { color: "#00A6A6" }]}>Outline Button</Text>
                    </TouchableOpacity>

                    {/* Ghost Button */}
                    <TouchableOpacity style={[styles.button, styles.ghostButton]}>
                    <Upload size={18} color="#111827" style={styles.iconLeft} />
                    <Text style={[styles.buttonText, styles.textDark]}>Ghost Button</Text>
                    </TouchableOpacity>
                </View>
        </View>
        <View style={styles.section}>
            ...
            <View style={styles.buttonSizesContainer}>
                <TouchableOpacity style={[styles.button, styles.primaryButton, styles.smButton]}>
                <Text style={[styles.buttonText, styles.textLight]}>Small</Text>
                </TouchableOpacity>

                <TouchableOpacity style={[styles.button, styles.primaryButton, styles.mdButton]}>
                <Text style={[styles.buttonText, styles.textLight]}>Medium</Text>
                </TouchableOpacity>

                <TouchableOpacity style={[styles.button, styles.primaryButton, styles.lgButton]}>
        ...
        <View>
            ...
            {categories.map((category) => (
                ...
                <View style={styles.iconWrapper}>
                    <CategoryIcon category={category.name} size={28} color="#00A6A6" />
                </View>
...
const styles = StyleSheet.create({
  ...
  colorLabel: { fontSize: 12, color: "#666", textAlign: "center", marginTop: 6 },
  typographyContainer: {
